...
def main():
    try:
        ...
        server_url = "http://172.20.10.2:5004"  # Replace <server-ip> with the actual server IP address
        ...
        while True:
            if instructions["action"] == "move_to_ball":
                ...
                print("Initial instructions: ball_point={}, blue_center={}, green_center={}, half_distance_cm={}, remaining_distance_cm={}, full_distance_cm={}".format(ball_point, blue_center, green_center, half_distance_cm, remaining_distance_cm, full_distance_cm))
                ...
                print("Initial instructions: dot_point={}, blue_center={}, green_center={}, half_distance_cm={}, remaining_distance_cm={}, full_distance_cm={}, small_goal={}".format(dot_point, blue_center, green_center, half_distance_cm, remaining_distance_cm, full_distance_cm, small_goal))

                # Align the robot with the dot
                align_robot(robot, blue_center, green_center, dot_point, correction_factor, server_url)
                print("The robot is aligned moving to if full_distance")

                if full_distance_cm > 20:
                    # Move half the distance to the dot if the full distance is greater than 20 cm
                    print("Full distance over 20 cm, move to dot function")
                ...
                print("Initial instructions: ball_point={}, field_dot={}, out_dot={}, blue_center={}, green_center={}, distance_to_ball={}".format(ball_point, field_dot, out_dot, blue_center, green_center, distance_to_ball))
                ...
                if distance_to_ball > 20:
                    # Move half the distance to the dot if the full distance is greater than 20 cm
                    print("Full distance over 20 cm, move to out dot function")
                    move_to_dot_function(robot, distance_to_ball / 2)
                    ...
                    if instructions["action"] == "move_to_ball_close_to_field":
                        ...
                        start_motors(motor_a, motor_d)
                        time.sleep(5)
                        print("Backing in case we messed up")
                        robot.straight(-100)
                    else:
                        move_to_dot_function(robot, remaining_distance_cm)
                        robot.straight(10)
                    ...
                    # Move directly to the dot if the full distance is 20 cm or less
                    move_to_dot_function(robot, distance_to_ball)
                    robot.straight(10)
                    time.sleep(2)
                    start_motors(motor_a, motor_d)
                    time.sleep(5)
